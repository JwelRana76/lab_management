                ...
                <td colspan="5">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <td colspan="2" width="100%" valign="top">
                                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="font-size:12px">
                                    ...
                                    <tr>
                                        ...
                                        <td width="10px">:</td>
                                        <td style="font-weight:bold">{{$patient->age}} {{ $patient->age_type == 1 ? 'Days':($patient->age_type == 2 ? 'Months':'Years') }}</td>
                                    </tr>
                                    <tr>
                        ...
                        <tr style="font-size:14px">
                            ...
                            <td style="padding:3px ;font-weight:bold; width:100px !important" align="right">{{$test->test->test_rate ?? 'N/A'}}</td>
                        </tr>
                        ...
                        @endphp
                        @foreach ($patient->tubes as $key=>$tube)
                        <tr style="font-size:14px">
                            <td style="padding:3px ;font-weight:bold;  text-align:left">{{$tube->tube->name ?? 'N/A'}}</td>
                            <td style="padding:3px ;font-weight:bold; width:100px !important" align="right">{{$tube->tube->rate * $tube->qty}}</td>
                        </tr>
            ...
            <tr>
                <td colspan="5">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr style="font-size:14px">
                            <td style="padding:3px ;font-weight:bold ; text-align:left">{{$test->test->name ??'N/A'}}</td>
                            <td style="padding:3px ;font-weight:bold; width:100px !important" align="right">{{$test->test_rate}}</td>
                        </tr>
                        ...
                        @foreach ($patient->tubes as $key=>$tube)
                        <tr style="font-size:14px">
                            <td style="padding:3px ;font-weight:bold;  text-align:left">{{$tube->tube->name}}</td>
                            <td style="padding:3px ;font-weight:bold; width:100px !important" align="right">{{$tube->tube->rate * $tube->qty}}</td>
                        </tr>
